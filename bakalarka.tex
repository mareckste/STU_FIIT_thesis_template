...
%-------definitions-----
\newcommand{\Author}{Meno Priezvisko} 
\newcommand{\Title}{Title English}
\newcommand{\Titlesk}{Title Slovak}
\newcommand{\Supervisor}{Supervisor}
\newcommand{\Place}{Institute of computer engineering and applied informatics, FIIT STU, Bratislava}
\newcommand{\Placesk}{Ústav počítačového inžinierstva a aplikovanej informatiky, FIIT STU, Bratislava}
\newcommand{\Year}{2017}
\newcommand{\Month}{May }
